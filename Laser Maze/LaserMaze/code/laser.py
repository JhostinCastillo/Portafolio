class Laser:
  ...
  def __init__(self, direccion=(0,1), posicion=(0,0)):
    ...
    self.izquierda = '\033[91m←\033[0m'
    self.derecha = '\033[91m→\033[0m'
    self.arriba = '\033[91m↑\033[0m'
    self.abajo = '\033[91m↓\033[0m'
    self.arriba_izquierda = '\033[91m↖\033[0m'
    self.arriba_derecha = '\033[91m↗\033[0m'
    self.abajo_izquierda = '\033[91m↙\033[0m'
    self.abajo_derecha = '\033[91m↘\033[0m'
